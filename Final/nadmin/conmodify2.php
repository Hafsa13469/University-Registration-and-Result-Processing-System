...
<table align="center" cellpadding="0"  width="800" border="0">
  <tr>
	...
	$result=mysql_fetch_array($resource);
	 ...
	 ?>
     	<form StudIdd="form1"name="form1" method="get" action="conmodify3.php">
	...
	<!--<input type="hidden" name="gr" value="<?php echo $result[0] ?>"  />--> 
        ...
        <p align="center"><a href="./conmodify1.php"><img  border="0" src="image/back.png" alt="Go Back" onmouseover="this.src='image/backover.png';" onmouseout="this.src='image/back.png';" /></a></p>
